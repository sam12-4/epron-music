                        ...
                        <table>
                          ...
                          <tr>
                            <td align="left" style="color:#777777;font-size:14px;line-height:21px;font-weight:400;">
                              ...
                              <p>
                                <?php
                                  printf( __('Hello %1$s, Your quote request for <a href="%2$s">%3$s</a> has beed placed. Your request is currently on <strong>Pending</strong>.', 'easyorder'),
                                    $customer_name, $product_url, $product_title
                                  );
                                ?>
                              </p>
