                        ...
                        <table>
                          ...
                          <tr>
                            <td align="left" style="color:#777777;font-size:14px;line-height:21px;font-weight:400;">
                              ...
                              <p>
                                <?php
                                  printf( __('Hello, Your have a new quote request for <a href="%1$s">%2$s</a>. The request is currently on <strong>Pending</strong>.', 'easyorder'),
