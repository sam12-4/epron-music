...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected' => esc_attr__( 'No File Selected', 'musico' ),
				'remove'         => esc_attr__( 'Remove', 'musico' ),
				'default'        => esc_attr__( 'Default', 'musico' ),
				'selectFile'     => esc_attr__( 'Select File', 'musico' ),
				'standardFonts'  => esc_attr__( 'Standard Fonts', 'musico' ),
				'googleFonts'    => esc_attr__( 'Google Fonts', 'musico' ),
			)
		);
