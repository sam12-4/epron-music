...
<div class="mobile_menu_wrapper">
    ...
    <?php
			...
			<div class="header_client_wrapper">
			    <a class="client_login_link" href="javascript:;" title="<?php esc_attr_e('Member Login', 'musico' ); ?>"><span class="ti-lock"></span><?php esc_html_e('client login Login', 'musico' ); ?></a>
			</div>
			<?php
				}
...
<?php
	$musico_page_menu_transparent = musico_get_page_menu_transparent();
	musico_set_page_menu_transparent($page_menu_transparent);
?>
<!-- End mobile menu -->