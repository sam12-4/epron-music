...
?><!DOCTYPE html>
<html <?php language_attributes(); ?> <?php if(isset($musico_homepage_style) && !empty($musico_homepage_style)) { echo 'data-style="'.esc_attr($musico_homepage_style).'"'; } ?> data-menu="<?php echo esc_attr($tg_menu_layout); ?>">
<head>
...
<body <?php body_class(); ?>>
	...
	<input type="hidden" id="pp_back" name="pp_back" value="<?php esc_html_e('Back', 'musico' ); ?>"/>
	...
	?>
	<div id="wrapper" class="<?php if(!empty($musico_page_menu_transparent)) { ?>hasbg<?php } ?> <?php if(!empty($page_menu_transparent)) { ?>transparent<?php } ?>">
